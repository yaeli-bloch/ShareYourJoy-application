...
// import { Container, Button, Grid, Box, Typography, Dialog, DialogTitle, DialogContent, DialogActions, List, ListItem, ListItemButton, ListItemText, Grid2 } from "@mui/material";
...
//       (file: any) => new Date(file.createdAt).toLocaleDateString() === date
//     );
...
//     // Create empty cells for the first row (week)
//     for (let i = 0; i < firstDayOfMonth; i++) {
//       calendar.push(<Box key={`empty-${i}`} />);
//     }
...
//               "&:hover": { backgroundColor: "#e0f7fa", borderRadius: "8px" },
...
//       {/* כפתורים למעבר בין חודשים */}
//       <Box sx={{ display: "flex", justifyContent: "space-between", marginBottom: "20px" }}>
//         <Button variant="contained" color="primary" onClick={() => handleMonthChange("prev")}>
//           חודש קודם
//         </Button>
//         <Typography variant="h6" sx={{ alignSelf: "center" }}>
//           {new Date(currentYear, currentMonth).toLocaleString("he-IL", { month: "long", year: "numeric" })}
//         </Typography>
//         <Button variant="contained" color="primary" onClick={() => handleMonthChange("next")}>
//           חודש הבא
//         </Button>
//       </Box>

//       <Grid container spacing={2} sx={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", marginBottom: "20px" }}>
//         {/* כותרות הימים */}
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>א</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ב</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ג</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ד</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ה</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ו</Typography></Grid>
//         <Grid item xs={1}><Typography align="center" sx={{ fontWeight: "bold" }}>ש</Typography></Grid>

//         {getCalendar()}
//       </Grid>

//       <Button onClick={handleBackToGroup} variant="outlined" sx={{ mt: 3, display: "block", margin: "0 auto" }}>
//         חזרה לעמוד הקבוצה
//       </Button>

//       {/* כאשר לוחצים על תאריך, הצגת רשימת האירועים */}
//       {selectedDate && eventsForSelectedDate.length > 0 && (
//         <Box sx={{ marginTop: 2 }}>
//           <Typography variant="h6" sx={{ marginBottom: "10px" }}>אירועים בתאריך {selectedDate}:</Typography>
//           <List>
...
//       {/* דיאלוג המציג את התמונה הגדולה */}
//       <Dialog open={dialogOpen} onClose={handleCloseDialog}>
//         <DialogTitle>פרטי התמונה</DialogTitle>
//         <DialogContent>
//           {selectedFile ? (
//             <Box sx={{ textAlign: "center" }}>
//               {/* הצגת התמונה בגודל גדול יותר */}
//               <img
...
//             </Box>
//           ) : (
//             <Typography>אין פרטים זמינים.</Typography>
//           )}
//         </DialogContent>
//         <DialogActions>
